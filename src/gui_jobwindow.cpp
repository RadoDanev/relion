...
void JobWindow::setupRunTab()
{
	...
	queue_group = new Fl_Group(WCOL0,  MENUHEIGHT, XCOL5, 600-MENUHEIGHT, "");
	queue_group->end();
...
void JobWindow::initialiseImportWindow()
{
	...
	group1 = new Fl_Group(WCOL0,  MENUHEIGHT, XCOL5, 600-MENUHEIGHT, "");
	group1->end();
	...
	group2 = new Fl_Group(WCOL0,  MENUHEIGHT, XCOL5, 600-MENUHEIGHT, "");
	group2->end();
...
void JobWindow::initialiseMotioncorrWindow()
{
	...
	current_y += STEPY/2;
	group4 = new Fl_Group(WCOL0,  MENUHEIGHT, XCOL5, 600-MENUHEIGHT, "");
	group4->end();
...
void JobWindow::initialiseAutopickWindow()
{
	...
	group3 = new Fl_Group(WCOL0,  MENUHEIGHT, XCOL5, 600-MENUHEIGHT, "");
	group3->end();
...
void JobWindow::initialiseExtractWindow()
{
	...
	group7 = new Fl_Group(WCOL0,  MENUHEIGHT, XCOL5, 600-MENUHEIGHT, "");
	group7->end();
...
Pixels values higher than this many times the image stddev will be replaced with values from a Gaussian distribution. \n \n Use negative value to switch off dust removal.");
	...
	group5 = new Fl_Group(WCOL0,  MENUHEIGHT, XCOL5, 600-MENUHEIGHT, "");
	group5->end();
	...
	group6 = new Fl_Group(WCOL0,  MENUHEIGHT, XCOL5, 600-MENUHEIGHT, "");
	group6->end();
...
void JobWindow::initialiseClass3DWindow()
{
	...
	group8 = new Fl_Group(WCOL0,  MENUHEIGHT, XCOL5, 600-MENUHEIGHT, "");
	group8->end();
